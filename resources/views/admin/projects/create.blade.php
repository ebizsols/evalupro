                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                                        ...
                                        <select class="selectpicker form-control" name="template_id" id="template_id"
                                            ...
                                            @forelse($templates as $template)
                                                <option value="{{ $template->id }}">
                                                    {{ ucwords($template->project_name) }}</option>
                                            @empty
                                ...
                                <div class="col-md-12 col-xs-12">
                                    <div class="form-group" id="user_id">
                                        ...
                                        <select class="select2 m-b-10 select2-multiple " id="selectEmployee"
                                            multiple="multiple" data-placeholder="Choose Members" name="user_id[]">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-4 mTop ">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="currency_id" id="" class="form-control select2">
                                            @foreach ($currencies as $item)
                                                <option @if (company_setting()->currency_id == $item->id)
                                                    selected
                                            @endif
                                ...
                                <div class="col-xs-12 col-md-4 ">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" name="appointment_day" id="appointment_day"
                                            class="form-control">
                                    </div>
                                </div>
                                ...
                                {{-- <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="" class="form-control">
                                            <option value="not started">@lang('app.notStarted')
                                            </option>
                                            <option value="in progress">@lang('app.inProgress')
                                            </option>
                                            <option value="on hold">@lang('app.onHold')
                                            </option>
                                            <option value="canceled">@lang('app.canceled')
                                            </option>
                                            <option value="finished">@lang('app.finished')
                                            </option>
                                        </select>
                                    </div>
                                </div> --}}
                                                            ...
                                                            <label class="radio-inline @if ($key == 0) p-0 @endif">
                                                                <div class="radio radio-info">
                                                                    <input type="radio"
                                                                        ...
                                                                        value="{{ $value }}" @if (isset($editUser) && $editUser->custom_fields_data['field_' . $field->id] == $value)
                                                                    checked
                                                                @elseif($key==0) checked
                                                        @endif>>
                                                        <label
