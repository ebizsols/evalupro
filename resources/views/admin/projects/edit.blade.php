                        ...
                        <div class="form-body ">
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <label class="control-label">@lang('modules.projects.projectCategory') <a
                                                href="javascript:;" id="addProjectCategory"><i
                                                    class="ti-settings text-info"></i></a>
                                        </label>
                                        <select class="select2 form-control" name="category_id" id="category_id"
                                            data-style="form-control">
                                            @forelse($categories as $category)
                                                <option value="{{ $category->id }}" @if ($project->category_id == $category->id)
                                                    selected
                                            @endif
                                ...
                                <div class="col-md-4" id="deadlineBox">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="deadline" id="deadline" autocomplete="off"
                                            class="form-control" value="@if ($project->deadline){{ $project->deadline->format($global->date_format) }}@else {{ \Carbon\Carbon::now()->format($global->date_format) }} @endif">
                                    </div>
                                </div>
                                <!--/span-->
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <label
                                            class="control-label">@lang('modules.projects.projectCompletionStatus')</label>
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group last">
                                        <div class="checkbox checkbox-info">
                                            ...
                                            <label
                                                for="calculate-task-progress">@lang('modules.projects.calculateTasksProgress')</label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <select class="select2 form-control" name="client_id" id="client_id"
                                            ...
                                            @forelse($clients as $client)
                                                <option value="{{ $client->id }}" @if ($project->client_id == $client->id)
                                                    selected
                                            @endif
                                ...
                                <div class="col-xs-12 col-md-4 mTop" id="clientNotification">
                                    <div class="form-group">
                                        <div class="checkbox checkbox-info  col-md-10">
                                            ...
                                            <label
                                                for="client_task_notification">@lang('modules.projects.clientTaskNotification')</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mBot">
                                    <div class="form-group">
                                        <label class="control-label required">Select Property <a href="javascript:;"
                                                id="addProperty" class="btn btn-xs btn-success btn-outline"><i
                                                    class="fa fa-plus"></i></a>
                                        </label>
                                        <select name="projectPropertyId" id="projectPropertyId"
                                            class="form-control projectPropertyId select2" required>
                                            <option value="">--</option>
                                            @if (isset($properties))
                                                @foreach ($properties as $property)
                                                    <option @if ($project->property_id == $property->id)
                                                        selected
                                                @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="currency_id" id="" class="form-control select2">
                                            ...
                                            @foreach ($currencies as $item)
                                                <option @if ($item->id == $project->currency_id) selected @endif value="{{ $item->id }}">
                                                    {{ $item->currency_name }} ({{ $item->currency_code }})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @elseif($field->type == 'textarea')
                                                <textarea
                                                    ...
                                                    cols="3">{{ $project->custom_fields_data['field_' . $field->id] ?? '' }}</textarea>
                                                        ...
                                                        <label class="radio-inline @if ($key == 0) p-0 @endif">
                                                            <div class="radio radio-info">
                                                                <input type="radio"
                                                                    ...
                                                                    value="{{ $value }}" @if (isset($project) && $project->custom_fields_data['field_' . $field->id] == $value) checked @elseif($key==0) checked @endif>>
                                                                <label
                                            ...
                                            @elseif($field->type == 'select')
                                                {!! Form::select('custom_fields_data[' . $field->name . '_' . $field->id . ']', $field->values, isset($project) ? $project->custom_fields_data['field_' . $field->id] : '', ['class' => 'form-control gender']) !!}
...
@push('footer-script')
    ...
    <script src="{{ asset('plugins/bower_components/ion-rangeslider/js/ion-rangeSlider/ion.rangeSlider.min.js') }}">
    </script>
