                ...
                <ul class="showProjectTabs">
                    ...
                    @if(in_array('employees',$modules))
                        <li class="projectMembers">
                            <a href="{{ route('admin.project-members.show', $project->id) }}"><i
                                        class="icon-people"></i> <span>@lang('modules.projects.members')</span></a>
                        </li>
                    @endif
                    ...
                    @endif
                    <li class="valuationAppointment">
                        <a href="{{ route('admin.valuation-appointment.show', $project->id) }}"><i
                                    class="icon-grid"></i> <span>Appointment</span></a>
                    </li>
                    <li class="inspectionReport">
                        <a href="{{ route('admin.valuation-inspection.show', $project->id) }}"><i
                                    class="icon-grid"></i> <span>Inspection Report</span></a>
                    </li>
                    <li class="valuationMethodology">
                        <a href="{{ route('admin.valuation-method.show', $project->id) }}"><i class="icon-grid"></i>
                            <span>Methodology</span></a>
                    </li>
                    <li class="projectReport">
                        <a href="{{ route('admin.report.show', $project->id) }}"><i class="ti-check-box"></i> <span>Valuation Finalization</span></a>
                    </li>
                <!--
                    @if(in_array('tasks',$modules))
        ...
        <div class="col-md-1 text-center tabs-more">
            <div class="btn-group dropdown m-r-10">
                <button aria-expanded="false" data-toggle="dropdown"
                        class="btn btn-default dropdown-toggle waves-effect waves-light" type="button"><i
                            class="fa fa-gears "></i></button>
                <ul role="menu" class="dropdown-menu pull-right">
                    <li><a href="{{ route('admin.projects.burndown-chart', $project->id) }}"><i class="icon-graph"
                                                                                                aria-hidden="true"></i> @lang('modules.projects.burndownChart')
                        </a>
                    </li>
                    @if(in_array('expenses',$modules))
                        <li><a href="{{ route('admin.project-expenses.show', $project->id) }}"><i
                                        class="ti-shopping-cart" aria-hidden="true"></i> @lang('app.menu.expenses')</a>
                        </li>
                    @endif

                    @if(in_array('payments',$modules))
                        <li><a href="{{ route('admin.project-payments.show', $project->id) }}"><i class="fa fa-money"
                                                                                                  aria-hidden="true"></i> @lang('app.menu.payments')
                            </a></li>
                    @endif
                    ...
                    @if(in_array('tasks',$modules))
                        <li class="projectTaskBoard">
                            <a href="{{ route('admin.tasks.kanbanboard', $project->id) }}"><i
