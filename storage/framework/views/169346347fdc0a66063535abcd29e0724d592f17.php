    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 mb-30 text-center">
                <p class="c-blue mb-2"><?php echo e($trFrontDetail->client_title ?: $defaultTrFrontDetail->client_title); ?></p>
                <h4><?php echo e($trFrontDetail->client_detail ?: $defaultTrFrontDetail->client_detail); ?></h4>
...
<?php /**PATH C:\xampp\htdocs\evalupro\resources\views/saas/section/client.blade.php ENDPATH**/ ?>