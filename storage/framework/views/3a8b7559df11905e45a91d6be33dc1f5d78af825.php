                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="time_format" id="time_format" class="form-control select2">
                                                    <option value="h:i A" <?php if($global->time_format == 'h:i A'): ?> selected <?php endif; ?> >12 Hour  (<?php echo e($dateObject->format('h:i A')); ?>) </option>
                                                    <option value="h:i a" <?php if($global->time_format == 'h:i a'): ?> selected <?php endif; ?> >12 Hour  (<?php echo e($dateObject->format('h:i a')); ?>) </option>
                                                    <option value="H:i" <?php if($global->time_format == 'H:i'): ?> selected <?php endif; ?> >24 Hour  (<?php echo e($dateObject->format('H:i')); ?>) </option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/evalupro/public_html/resources/views/admin/settings/edit.blade.php ENDPATH**/ ?>