    ...
    <div class="message-center">
        <a href="<?php echo e(route('front.task-share',[md5($notification->data['id'])])); ?>" target="_blank">
            ...
            <div class="mail-contnet">
                <span class="mail-desc m-0"><?php echo app('translator')->get('email.taskNote.subject'); ?></span>
...
<?php /**PATH /home/evalupro/public_html/resources/views/notifications/admin/task_note.blade.php ENDPATH**/ ?>