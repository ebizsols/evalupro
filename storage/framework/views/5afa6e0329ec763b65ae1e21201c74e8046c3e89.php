...
<script>
    ...
    $(function() {
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                text: "<?php echo app('translator')->get('messages.confirmation.deleteNotice'); ?>",
                type: "warning",
    ...
    $('body').on('click', '.view-notice', function(){
        ...
        var url = "<?php echo e(route('admin.notices.show',':id')); ?>";
        url = url.replace(':id', id);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/evalupro/public_html/resources/views/admin/notices/index.blade.php ENDPATH**/ ?>