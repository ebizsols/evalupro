...
<?php $__env->startPush('footer-script'); ?>
    ...
    <script>
        $('#saveUpdateConditionRules').click(function () {
            ...
            $.easyAjax({
                url: '<?php echo e(route($saveUpdateRuleRoute, isset($id)?$id:0)); ?>',
            ...
            $('body').on('click', '.sa-params', function () {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        var url = "<?php echo e(route('valuation.admin.settings.general.destroyRule',':id')); ?>";
...
//                                    swal("Deleted!", response.message, "success");
        ...
        function loadEditData(EditId) {
            if (EditId != '' && EditId > 0) {
                $.ajax({
                    type: 'get',
                    url: "<?php echo e(route('valuation.admin.settings.general.editData')); ?>/" + EditId,
                    cache: false,
                    success: function (response) {
...
<?php $__env->stopPush(); ?><?php /**PATH /home/evalupro/public_html/Modules/Valuation/Resources/views/Admin/Settings/General/ConditionalRules.blade.php ENDPATH**/ ?>