...
<script>
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            url: '<?php echo e(route('admin.dashboard.widget', "admin-ticket-dashboard")); ?>',
    ...
    function loadData () {
            ...
            var url = '<?php echo e(route('admin.ticketDashboard')); ?>?startDate=' + startDate + '&endDate=' + endDate;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/evalupro/public_html/resources/views/admin/dashboard/ticket.blade.php ENDPATH**/ ?>