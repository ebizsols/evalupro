                                                            ...
                                                            <div class="row">
                                                                <div class="col-xs-12">
                                                                    <div class="form-group">
                                                                        <label class="control-label required"><?php echo app('translator')->get('app.title'); ?></label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="checkbox checkbox-info">
                                                                            <input id="billable-task" name="billable" value="true"
                                                                                   type="checkbox">
                                                                            <label for="billable-task"><?php echo app('translator')->get('modules.tasks.billable'); ?> <a class="mytooltip font-12" href="javascript:void(0)"> <i class="fa fa-info-circle"></i><span class="tooltip-content5"><span class="tooltip-text3"><span class="tooltip-inner2"><?php echo app('translator')->get('modules.tasks.billableInfo'); ?></span></span></span></a></label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        <div class="checkbox checkbox-info">
                                                                            ...
                                                                            <label for="set-time-estimate"><?php echo app('translator')->get('modules.tasks.setTimeEstimate'); ?></label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div id="set-time-estimate-fields" style="display: none">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number" min="0" value="0" class="w-50 p-5 p-10" name="estimate_hours" > <?php echo app('translator')->get('app.hrs'); ?>
                                                                            &nbsp;&nbsp;
                                                                            <input type="number" min="0" value="0" name="estimate_minutes" class="w-50 p-5 p-10"> <?php echo app('translator')->get('app.mins'); ?>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label required"><?php echo app('translator')->get('modules.projects.startDate'); ?></label>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label required"><?php echo app('translator')->get('app.dueDate'); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/evalupro/public_html/resources/views/admin/projects/tasks/show.blade.php ENDPATH**/ ?>