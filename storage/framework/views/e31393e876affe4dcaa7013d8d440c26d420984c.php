                        ...
                        <ul class="navbar-nav ml-auto">
                            <?php $__currentLoopData = $footerSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $footerSetting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($footerSetting->type != 'header'): ?>
                                    <li class="nav-item active"><a class="nav-link" href="<?php if(!is_null($footerSetting->external_link)): ?> <?php echo e($footerSetting->external_link); ?> <?php else: ?> <?php echo e(route('front.page', $footerSetting->slug)); ?> <?php endif; ?>"><?php echo e($footerSetting->name); ?></a></li>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <li class="nav-item">
...
<?php /**PATH C:\xampp\htdocs\evalupro\resources\views/sections/saas/saas_footer.blade.php ENDPATH**/ ?>